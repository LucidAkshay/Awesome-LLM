...
- [VikaasLoop](https://github.com/LucidAkshay/vikaasloop) - An autonomous 5-agent engine for end-to-end LLM fine-tuning, automating data generation, QLoRA training, and evaluation.
